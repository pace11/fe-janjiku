...
import audio from '../../sound/Yovie&Nuno_Janji_Suci.mp3'
                ...
                >
                  <div className="col-md-12 content-center">
                    ...
                    <img
                      ...
                      alt=""
                    />
                    <p className="bride-name">~ Afni & Rehan ~</p>
                    <p className="desc-1">
                ...
                >
                  <div className="col-md-12 content-center">
                    ...
                    <p className="desc-1">
                      ...
                      makhluk-Nya berpasang-pasangan. Ya Allah semoga Ridho-Mu mencurah mengiringi pernikahan putra-putri kami:
                    </p>
                    <p className="text-male">
                      Maulida Afni Mulyani, SE
                      <br />
                      <span>"Afni"</span>
                      <br />
                      <span>
                        Putri kedua dari Bapak Ir. Muliadi & Ibu Mariani
                      </span>
                    </p>
                    <p className="and">&</p>
                    <p className="text-female">
                      Fahmi Roihanul Firdaus, ST
                      <br />
                      <span>"Rehan"</span>
                      <br />
                      <span>
                        Putra kedua dari Bapak Firstep Eapl Astimen, S.Kom, M.Si & Ibu Siti Munawaroh
                      </span>
                    </p>
                    <p className="desc-1">
                      Untuk mengikuti sunnah Rasul-Mu dalam rangka membentuk keluarga yang Sakinah, Mawaddah, Warahmah maka izikanlah kami menikahkannya.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="col-md-6">
                      <div className="row box-schedule">
                        <div className="col-md-6">
                          ...
                          <p>
                            <i className="far fa-calendar-alt"></i> 19
                            Februari 2023
                            <br />
                            <i className="far fa-clock"></i> 08:00 - 09:30 WITA
                            <br />
                            <i className="fab fa-instagram"></i> <b>LIVE STREAMING di <a href="https://www.instagram.com/frfirdaus/" target="_blank" rel="noreferrer">@frfirdaus</a></b>
                          </p>
                          <p className="place-address">
                            Aula Gajah Mada, Jl. Gatot Subroto X Banjarmasin
                          </p>
                        </div>
                        <div className="col-md-6">
                          ...
                          <p>
                            <i className="far fa-calendar-alt"></i> 19
                            Februari 2023 <br />
                            <i className="far fa-clock"></i> 10:00 WITA - Selesai
                          </p>
                          <p className="place-address">
                            Aula Gajah Mada, Jl. Gatot Subroto X Banjarmasin
                          </p>
                    ...
                    <div className="mapouter">
                      <div className="gmap_canvas">
                        <iframe
                          title="maps-layout"
                          id="gmap_canvas"
                          src="https://maps.google.com/maps?q=MJG9%2BM8X+Hall+of+Gadjah+Mada,+Pengambangan,+Banjarmasin+Timur,+Banjarmasin+City,+South+Kalimantan+70239&t=&z=13&ie=UTF8&iwloc=&output=embed"
                          frameBorder="0"
                          scrolling="no"
                          marginHeight="0"
                          marginWidth="0"
                ...
                >
                  <div className="col-md-12 content-center">
                    ...
                    <div className="gallery-photo">
                      <img
                        src={
                          require('../../images/rehan/rehan-1.jpg')
                            .default
                        }
                        alt=""
                      />
                  ...
                  <div className="col-md-12 content-center">
                    ...
                    <div className="row content-center">
                      <div className="row m-20">
                        <Card
                          name="FAHMI ROIHANUL FIRDAUS"
                          number="1180010112117"
                          type="mandiri"
                        />
                      </div>
                      <div className="row m-20">
                        <Card
                          name="MAULIDA AFNI MULYANI"
                          number="0310013303048"
                          type="mandiri"
                        />
                      </div>
                    </div>
